      ...
      <div class="row p-4">
        ...
        <div class="col-sm-12 col-md-6 col-lg-6 mb-4 p-4">
          <div class="container justify-content-center float-start">
            <h1 class="text-dark">De que pueden disfrutar por primer su acceso</h1>
            <p class="text-dark">En AdopMe estamos al tanto de que la limpieza de nuestras mascotas es ideal y crucial no solo para el aspecto de estas, sino para prevenirlas de ciertas bacterias que pueden causar diversos tipos de enfermedades en nuestras mascotas, nuestra tienda ofrece al público que adquiere nuestras mascotas un acceso a limpieza con todo incluido por ser adquiridor de nuestros ejemplares, pregunta a nuestros desarrolladores de este maravilloso programa por mas información.</p>
            <hr>
        ...
        <div class="col-sm-12">
          ...
          <div class="container mb-4">
            ...
            foreach ($comentarios as $comentario) {
              echo "<div class='bg-light p-2 mb-2 rounded' style='word-wrap: break-word;'>" . $comentario . "</div>";
            }
            ?>
          </div>
          <form action="comentarios.php" method="POST">
            <textarea name="comentario" class="form-control mb-2"></textarea>
            <button type="submit" class="btn btn-primary mb-2">Agregar comentario</button>
            <a href="borrar_comentarios.php" class="btn btn-danger mb-2">Borrar comentarios</a>
          </form>
        </div>
      </div>
    </section>
